...
Free app, zero IAP. App title: **Stack Duel**. Play/AdMob developer name: **Clack Crew** (@theclackcrew). Vendetta uses an optional rewarded ad (Play again never requires it).
